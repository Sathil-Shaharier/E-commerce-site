...
(30001, 2345678, '017********', 'Toyota Corola', '2010 KM and good CONDITION', '2000 per day', 'Yes', 4),
(30002, 2345678, '017********', 'Toyota NOAH', '2410 KM and good CONDITION', '3500 per day', 'Yes', 8);
...
(40001, 3456789, '017********', 'Hyundai Tucson', '1510 KM and good CONDITION', '3000 per day', 'Yes', 4),
(40002, 1234567, '017********', 'Toyota 86 GT', '1200 KM and good CONDITION', '3500 per day', 'Yes', 4);
...
(5666666, 40001, 'abid.hasan@northsouth.edu', '017********', 'Sherpur', 2100, 'abidhasan01');
...
('Bulbul', 'Hasan', 'Bulbulhasan', 1011111, '019********', 'Bulbulhasan55@gmail.com', 'Sherpur', 'Male', 22, 'bbbbb'),
('Tanzila', 'Rahman', 'Tanzilarahman', 1112121, '019********', 'TanzilaRahman55@gmail.com', 'Sherpur', 'Male', 19, 'ttttt'),
('Tasbiul', 'Olive', 'TasbiuslOlive', 1234567, '017*******', 'tasbiul.hasan@northsouth.edu', 'Faridpur', 'male', 22, 'ttttt'),
('Pranab', 'Roy', 'PranabRoy', 2345678, '017********', 'pranab.roy@northsouth.edu', 'Bramanbaria', 'male', 22, 'ppppp'),
('Iqbal', 'Hossain', 'iqbalHoosain', 3444444, '018********', 'iqbal.hossain@northsouth.edu', 'Nowakhali', 'Male', 22, 'lllll'),
('Shaharier', 'Sathil', 'ShaharierSathil', 3456789, '017********', 'Shaharier.hoque@northsouth.edu', 'Sherpur', 'male', 22, 'sssss'),
('Lanisa', 'Siddika', 'lanisasiddika', 4555555, '017********', 'laniisaa.siddika@northsouth.edu', 'Comilla', 'Female', 22, 'iiiii'),
('Abid', 'Hasan', 'abidhasan01', 5666666, '017********', 'abid.hasan@northsouth.edu', 'Sherpur', 'Male', 22, 'aaaaa'),
('Rudnan', 'Ahmeed', 'Rudnanahmmed01', 6777777, '017********', 'rudnantanzim@gmail.com', 'Sherpur', 'Male', 17, '2580'),
('Adiba', 'Abonee', 'AdibaAbonee', 7888888, '017********', 'adbibadtasnim69@gmail.com', 'Sherpur', 'Female', 21, 'Addd'),
('Bishal', 'Azmain', 'BishalAzmain', 8999999, '016********', 'bishalazmail84@gmail.com', 'Kisorgong', 'Male', 22, 'bbbb');
